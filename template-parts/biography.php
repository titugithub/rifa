<?php
    ...
    $author_info = get_the_author_meta( 'rifa_write_by');
    $facebook_url = get_the_author_meta( 'rifa_facebook' );
    $twitter_url = get_the_author_meta( 'rifa_twitter' );
    $linkedin_url = get_the_author_meta( 'rifa_linkedin' );
    $instagram_url = get_the_author_meta( 'rifa_instagram' );
    $rifa_url = get_the_author_meta( 'rifa_youtube' );
    $rifa_write_by = get_the_author_meta( 'rifa_write_by' );
